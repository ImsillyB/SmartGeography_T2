...
//        db.update("jankinData", values, "keyid=?", new String[]{Info.get("keyid")});
	...
	public List<Map<String,String>> getScrollData(String username, int offset, int maxResult){  
        List<Map<String,String>> ListMap = new ArrayList<Map<String,String>>();  
        //如果只对数据进行读取，建议使用此方法
        SQLiteDatabase db = getReadableDatabase();  
        Cursor cursor = db.rawQuery("select * from jankinData limit ?,?",  new String[]{""+offset, ""+maxResult});  
